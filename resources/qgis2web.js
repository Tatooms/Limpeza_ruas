...
map.getView().fit([-964096.896502, 5250332.149450, -959953.921133, 5252508.149450], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Limpeza das rúas no centro urbán de Caldas de Reis</h2>';
        return titleElement;
    })(),
